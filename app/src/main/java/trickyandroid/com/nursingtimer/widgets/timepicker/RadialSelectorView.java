...
public class RadialSelectorView extends View {
    ...
    public ObjectAnimator getDisappearAnimator() {
        ...
        PropertyValuesHolder fadeOut = PropertyValuesHolder.ofKeyframe(View.ALPHA, kf0, kf1);
    ...
    public ObjectAnimator getReappearAnimator() {
        ...
        PropertyValuesHolder fadeIn = PropertyValuesHolder.ofKeyframe(View.ALPHA, kf0, kf1, kf2);
